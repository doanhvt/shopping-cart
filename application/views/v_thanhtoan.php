                ...
                <div align="center">
                    ...
                    <table border="0" cellpadding="2px">
                        <tbody>
                            ...
                            <tr><td>Address:</td><td><textarea name="address" cols="35" rows="5"  required=""></textarea></td></tr>
                            <tr>
                                <td><a class="fg-button teal" id="back" href="<?php echo base_url('shopping'); ?>">Shopping</a>                            </td>
